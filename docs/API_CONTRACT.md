...
> **Note**: For Admin-specific endpoints (User Management, Cohorts, Bulk Uploads, and Admin Academic Records), please refer to the [`ADMIN_CONTRACT.md`](./ADMIN_CONTRACT.md) document.
